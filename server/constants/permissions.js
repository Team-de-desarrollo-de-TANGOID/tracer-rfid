...
export const PERMISSIONS = [
  ...
  { codigo: 'auditoria.ejecutar', nombre: 'Ejecutar auditoría rápida', modulo: 'auditoria' },
  { codigo: 'auditoria.ver_historial', nombre: 'Ver historial de auditorías', modulo: 'auditoria' },
  { codigo: 'sync.ejecutar', nombre: 'Sincronizar con lector de puerta', modulo: 'sync' },
